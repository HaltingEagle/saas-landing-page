        ...
        <section className="relative pb-40 pt-60 max-lg:pt-52 max-lg:pb-36 max-md:pt-36 max-md:pb-32">
            ...
            <div className="container">
                <div className="relative z-2 max-w-512 max-lg:max-w-388">
                    ...
                    <p className="max-w-440 mb-14 body-1 max-md:mb-10">We designed XORA AI Video Editior to be an easy to use, quick to learn, and suprisingly easy to use.</p>
                    <LinkScroll to="features" offset={-100} spy smooth>
                        <Button icon="/images/zap.svg" title="button">Try it now</Button>
                    </LinkScroll>
                </div>
